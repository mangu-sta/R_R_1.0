...
-- 테이블 데이터 rr.friend_requests:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 rr.maps:~11 rows (대략적) 내보내기
...
INSERT INTO `monsters` (`attack_speed`, `damage`, `hp`, `max_hp`, `pos_x`, `pos_y`, `range`, `speed`, `id`, `map_id`, `name`, `type`) VALUES
	(1, 5, 120, 120, 915.5, 380.25, 50, 45, 37, 7, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1300, 800, 50, 45, 38, 7, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1500, 1200, 50, 45, 39, 7, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1300, 800, 50, 45, 40, 4, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1500, 1200, 50, 45, 41, 4, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 915.5, 380.25, 50, 45, 42, 4, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 915.5, 380.25, 50, 45, 43, 13, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1500, 1200, 50, 45, 44, 13, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1300, 800, 50, 45, 45, 13, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1500, 1200, 50, 45, 46, 10, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 915.5, 380.25, 50, 45, 47, 10, 'SLOW', 'NORMAL'),
	(1, 5, 120, 120, 1300, 800, 50, 45, 48, 10, 'SLOW', 'NORMAL');
